...
// Target An object representing a performance target for a line, product, and metric group.
type Target struct {
	MetricGroup *MetricGroup `json:"metric_group,omitempty"`
...
// GetLsl returns the Lsl field value if set, zero value otherwise.
func (o *Target) GetLsl() float64 {
	if o == nil || IsNil(o.Lsl) {
		var ret float64
		return ret
	}
	return *o.Lsl
...
// GetLslOk returns a tuple with the Lsl field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetLsl gets a reference to the given float64 and assigns it to the Lsl field.
func (o *Target) SetLsl(v float64) {
	o.Lsl = &v
}

// GetUsl returns the Usl field value if set, zero value otherwise.
func (o *Target) GetUsl() float64 {
	if o == nil || IsNil(o.Usl) {
		var ret float64
		return ret
	}
	return *o.Usl
...
// GetUslOk returns a tuple with the Usl field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetUsl gets a reference to the given float64 and assigns it to the Usl field.
...
func (o Target) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MetricGroup) {
		toSerialize["metric_group"] = o.MetricGroup
	}
	if !IsNil(o.Product) {
	...
	if !IsNil(o.Lsl) {
		toSerialize["lsl"] = o.Lsl
	}
	if !IsNil(o.Usl) {
		toSerialize["usl"] = o.Usl
	}
	if !IsNil(o.Match) {
