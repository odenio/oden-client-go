...
// checks if the SearchScrapYieldRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchScrapYieldRequest{}

// SearchScrapYieldRequest struct for SearchScrapYieldRequest
type SearchScrapYieldRequest struct {
	Data *ScrapYieldData `json:"data,omitempty"`
	Interval Interval `json:"interval"`
}

type _SearchScrapYieldRequest SearchScrapYieldRequest
...
func (o SearchScrapYieldRequest) MarshalJSON() ([]byte, error) {
...
func (o SearchScrapYieldRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SearchScrapYieldRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSearchScrapYieldRequest := _SearchScrapYieldRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSearchScrapYieldRequest)

	if err != nil {
		return err
	}

	*o = SearchScrapYieldRequest(varSearchScrapYieldRequest)

	return err
}

type NullableSearchScrapYieldRequest struct {
	value *SearchScrapYieldRequest
	isSet bool
}

func (v NullableSearchScrapYieldRequest) Get() *SearchScrapYieldRequest {
	return v.value
}

func (v *NullableSearchScrapYieldRequest) Set(val *SearchScrapYieldRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchScrapYieldRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchScrapYieldRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchScrapYieldRequest(val *SearchScrapYieldRequest) *NullableSearchScrapYieldRequest {
	return &NullableSearchScrapYieldRequest{value: val, isSet: true}
}

func (v NullableSearchScrapYieldRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchScrapYieldRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
