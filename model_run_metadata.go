...
var _ MappedNullable = &RunMetadata{}
...
func (o RunMetadata) MarshalJSON() ([]byte, error) {
...
type NullableRunMetadata struct {
	value *RunMetadata
	isSet bool
}

func (v NullableRunMetadata) Get() *RunMetadata {
	return v.value
}

func (v *NullableRunMetadata) Set(val *RunMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRunMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRunMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRunMetadata(val *RunMetadata) *NullableRunMetadata {
	return &NullableRunMetadata{value: val, isSet: true}
}

func (v NullableRunMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRunMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
