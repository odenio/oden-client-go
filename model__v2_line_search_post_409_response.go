...
// checks if the V2LineSearchPost409Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2LineSearchPost409Response{}

// V2LineSearchPost409Response struct for V2LineSearchPost409Response
type V2LineSearchPost409Response struct {
	EntityName string `json:"entity_name"`
	NumMatches int32 `json:"num_matches"`
	Error string `json:"error"`
	Retryable bool `json:"retryable"`
}

type _V2LineSearchPost409Response V2LineSearchPost409Response
...
func NewV2LineSearchPost409Response(entityName string, numMatches int32, error_ string, retryable bool) *V2LineSearchPost409Response {
	this := V2LineSearchPost409Response{}
...
// GetNumMatches returns the NumMatches field value
...
// GetNumMatchesOk returns a tuple with the NumMatches field value
// and a boolean to check if the value has been set.
func (o *V2LineSearchPost409Response) GetNumMatchesOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.NumMatches, true
}

// SetNumMatches sets field value
...
func (o V2LineSearchPost409Response) MarshalJSON() ([]byte, error) {
...
func (o V2LineSearchPost409Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["entity_name"] = o.EntityName
	toSerialize["num_matches"] = o.NumMatches
	toSerialize["error"] = o.Error
	toSerialize["retryable"] = o.Retryable
	return toSerialize, nil
}

func (o *V2LineSearchPost409Response) UnmarshalJSON(data []byte) (err error) {
	...
	varV2LineSearchPost409Response := _V2LineSearchPost409Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV2LineSearchPost409Response)

	if err != nil {
		return err
	}

	*o = V2LineSearchPost409Response(varV2LineSearchPost409Response)

	return err
}

type NullableV2LineSearchPost409Response struct {
	value *V2LineSearchPost409Response
	isSet bool
}

func (v NullableV2LineSearchPost409Response) Get() *V2LineSearchPost409Response {
	return v.value
}

func (v *NullableV2LineSearchPost409Response) Set(val *V2LineSearchPost409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2LineSearchPost409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2LineSearchPost409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2LineSearchPost409Response(val *V2LineSearchPost409Response) *NullableV2LineSearchPost409Response {
	return &NullableV2LineSearchPost409Response{value: val, isSet: true}
}

func (v NullableV2LineSearchPost409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2LineSearchPost409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
