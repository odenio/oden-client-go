...
// checks if the OQLQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OQLQuery{}

// OQLQuery An object representing an OQL query.
type OQLQuery struct {
	Query string `json:"query"`
}

type _OQLQuery OQLQuery
...
func (o OQLQuery) MarshalJSON() ([]byte, error) {
...
func (o OQLQuery) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["query"] = o.Query
	return toSerialize, nil
}

func (o *OQLQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varOQLQuery := _OQLQuery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOQLQuery)

	if err != nil {
		return err
	}

	*o = OQLQuery(varOQLQuery)

	return err
}

type NullableOQLQuery struct {
	value *OQLQuery
	isSet bool
}

func (v NullableOQLQuery) Get() *OQLQuery {
	return v.value
}

func (v *NullableOQLQuery) Set(val *OQLQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableOQLQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableOQLQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOQLQuery(val *OQLQuery) *NullableOQLQuery {
	return &NullableOQLQuery{value: val, isSet: true}
}

func (v NullableOQLQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOQLQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
