...
// checks if the SetScrapYieldRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetScrapYieldRequest{}

// SetScrapYieldRequest struct for SetScrapYieldRequest
type SetScrapYieldRequest struct {
	Data ScrapYieldData `json:"data"`
	Interval Interval `json:"interval"`
}

type _SetScrapYieldRequest SetScrapYieldRequest
...
func (o SetScrapYieldRequest) MarshalJSON() ([]byte, error) {
...
func (o SetScrapYieldRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SetScrapYieldRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSetScrapYieldRequest := _SetScrapYieldRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSetScrapYieldRequest)

	if err != nil {
		return err
	}

	*o = SetScrapYieldRequest(varSetScrapYieldRequest)

	return err
}

type NullableSetScrapYieldRequest struct {
	value *SetScrapYieldRequest
	isSet bool
}

func (v NullableSetScrapYieldRequest) Get() *SetScrapYieldRequest {
	return v.value
}

func (v *NullableSetScrapYieldRequest) Set(val *SetScrapYieldRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSetScrapYieldRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSetScrapYieldRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetScrapYieldRequest(val *SetScrapYieldRequest) *NullableSetScrapYieldRequest {
	return &NullableSetScrapYieldRequest{value: val, isSet: true}
}

func (v NullableSetScrapYieldRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetScrapYieldRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
