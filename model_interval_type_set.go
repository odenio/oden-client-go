...
// checks if the IntervalTypeSet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntervalTypeSet{}

// IntervalTypeSet Create or update a custom interval type. Omit `id` to create (requires `name`); include `id` to update. On update, `name` (if present) is ignored. Use `null` for `tags` to leave tags unchanged; `[]` clears tags. 
type IntervalTypeSet struct {
...
// NewIntervalTypeSet instantiates a new IntervalTypeSet object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewIntervalTypeSet() *IntervalTypeSet {
	this := IntervalTypeSet{}
	return &this
}

// NewIntervalTypeSetWithDefaults instantiates a new IntervalTypeSet object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewIntervalTypeSetWithDefaults() *IntervalTypeSet {
	this := IntervalTypeSet{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *IntervalTypeSet) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *IntervalTypeSet) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *IntervalTypeSet) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *IntervalTypeSet) SetId(v string) {
	o.Id = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *IntervalTypeSet) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *IntervalTypeSet) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *IntervalTypeSet) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *IntervalTypeSet) SetName(v string) {
	o.Name = &v
}

// GetMetadataSchema returns the MetadataSchema field value if set, zero value otherwise.
func (o *IntervalTypeSet) GetMetadataSchema() string {
...
// and a boolean to check if the value has been set.
func (o *IntervalTypeSet) GetMetadataSchemaOk() (*string, bool) {
	if o == nil || IsNil(o.MetadataSchema) {
		return nil, false
	}
...
func (o *IntervalTypeSet) HasMetadataSchema() bool {
	if o != nil && !IsNil(o.MetadataSchema) {
		return true
	}
...
// SetMetadataSchema gets a reference to the given string and assigns it to the MetadataSchema field.
func (o *IntervalTypeSet) SetMetadataSchema(v string) {
	o.MetadataSchema = &v
}

// GetTags returns the Tags field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *IntervalTypeSet) GetTags() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *IntervalTypeSet) GetTagsOk() ([]string, bool) {
...
func (o *IntervalTypeSet) HasTags() bool {
	if o != nil && !IsNil(o.Tags) {
		return true
	}
...
func (o *IntervalTypeSet) SetTags(v []string) {
	o.Tags = v
}

func (o IntervalTypeSet) MarshalJSON() ([]byte, error) {
...
func (o IntervalTypeSet) ToMap() (map[string]interface{}, error) {
...
type NullableIntervalTypeSet struct {
	value *IntervalTypeSet
	isSet bool
}

func (v NullableIntervalTypeSet) Get() *IntervalTypeSet {
	return v.value
}

func (v *NullableIntervalTypeSet) Set(val *IntervalTypeSet) {
	v.value = val
	v.isSet = true
}

func (v NullableIntervalTypeSet) IsSet() bool {
	return v.isSet
}

func (v *NullableIntervalTypeSet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntervalTypeSet(val *IntervalTypeSet) *NullableIntervalTypeSet {
	return &NullableIntervalTypeSet{value: val, isSet: true}
}

func (v NullableIntervalTypeSet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntervalTypeSet) UnmarshalJSON(src []byte) error {
	v.isSet = true
