...
// checks if the BulkUpdateIntervals200ResponseFailedIntervalsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkUpdateIntervals200ResponseFailedIntervalsInner{}

// BulkUpdateIntervals200ResponseFailedIntervalsInner struct for BulkUpdateIntervals200ResponseFailedIntervalsInner
type BulkUpdateIntervals200ResponseFailedIntervalsInner struct {
	Id *string `json:"id,omitempty"`
	Error *string `json:"error,omitempty"`
}

// NewBulkUpdateIntervals200ResponseFailedIntervalsInner instantiates a new BulkUpdateIntervals200ResponseFailedIntervalsInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBulkUpdateIntervals200ResponseFailedIntervalsInner() *BulkUpdateIntervals200ResponseFailedIntervalsInner {
	this := BulkUpdateIntervals200ResponseFailedIntervalsInner{}
	return &this
}

// NewBulkUpdateIntervals200ResponseFailedIntervalsInnerWithDefaults instantiates a new BulkUpdateIntervals200ResponseFailedIntervalsInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewBulkUpdateIntervals200ResponseFailedIntervalsInnerWithDefaults() *BulkUpdateIntervals200ResponseFailedIntervalsInner {
	this := BulkUpdateIntervals200ResponseFailedIntervalsInner{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *BulkUpdateIntervals200ResponseFailedIntervalsInner) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *BulkUpdateIntervals200ResponseFailedIntervalsInner) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *BulkUpdateIntervals200ResponseFailedIntervalsInner) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *BulkUpdateIntervals200ResponseFailedIntervalsInner) SetId(v string) {
	o.Id = &v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *BulkUpdateIntervals200ResponseFailedIntervalsInner) GetError() string {
...
// and a boolean to check if the value has been set.
func (o *BulkUpdateIntervals200ResponseFailedIntervalsInner) GetErrorOk() (*string, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *BulkUpdateIntervals200ResponseFailedIntervalsInner) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
func (o *BulkUpdateIntervals200ResponseFailedIntervalsInner) SetError(v string) {
	o.Error = &v
}

func (o BulkUpdateIntervals200ResponseFailedIntervalsInner) MarshalJSON() ([]byte, error) {
...
func (o BulkUpdateIntervals200ResponseFailedIntervalsInner) ToMap() (map[string]interface{}, error) {
...
type NullableBulkUpdateIntervals200ResponseFailedIntervalsInner struct {
	value *BulkUpdateIntervals200ResponseFailedIntervalsInner
	isSet bool
}

func (v NullableBulkUpdateIntervals200ResponseFailedIntervalsInner) Get() *BulkUpdateIntervals200ResponseFailedIntervalsInner {
	return v.value
}

func (v *NullableBulkUpdateIntervals200ResponseFailedIntervalsInner) Set(val *BulkUpdateIntervals200ResponseFailedIntervalsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkUpdateIntervals200ResponseFailedIntervalsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkUpdateIntervals200ResponseFailedIntervalsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkUpdateIntervals200ResponseFailedIntervalsInner(val *BulkUpdateIntervals200ResponseFailedIntervalsInner) *NullableBulkUpdateIntervals200ResponseFailedIntervalsInner {
	return &NullableBulkUpdateIntervals200ResponseFailedIntervalsInner{value: val, isSet: true}
}

func (v NullableBulkUpdateIntervals200ResponseFailedIntervalsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkUpdateIntervals200ResponseFailedIntervalsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
