...
// checks if the ScrapYieldData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScrapYieldData{}

// ScrapYieldData An object representing scrap and yield data for a line for a particular run or batch interval. Data can be sent unstructured in the `raw_data` field as long as we have a scrap/yield schema for the factory. 
type ScrapYieldData struct {
	RawData *string `json:"raw_data,omitempty"`
	Id *string `json:"id,omitempty"`
	Schema *ScrapYieldSchema `json:"schema,omitempty"`
...
// SetSchema gets a reference to the given ScrapYieldSchema and assigns it to the Schema field.
...
func (o *ScrapYieldData) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o ScrapYieldData) MarshalJSON() ([]byte, error) {
...
func (o ScrapYieldData) ToMap() (map[string]interface{}, error) {
...
type NullableScrapYieldData struct {
	value *ScrapYieldData
	isSet bool
}

func (v NullableScrapYieldData) Get() *ScrapYieldData {
	return v.value
}

func (v *NullableScrapYieldData) Set(val *ScrapYieldData) {
	v.value = val
	v.isSet = true
}

func (v NullableScrapYieldData) IsSet() bool {
	return v.isSet
}

func (v *NullableScrapYieldData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScrapYieldData(val *ScrapYieldData) *NullableScrapYieldData {
	return &NullableScrapYieldData{value: val, isSet: true}
}

func (v NullableScrapYieldData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScrapYieldData) UnmarshalJSON(src []byte) error {
	v.isSet = true
