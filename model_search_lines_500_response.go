...
// checks if the SearchLines500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchLines500Response{}

// SearchLines500Response struct for SearchLines500Response
type SearchLines500Response struct {
	Error string `json:"error"`
	Retryable bool `json:"retryable"`
	Id string `json:"id"`
}

type _SearchLines500Response SearchLines500Response

// NewSearchLines500Response instantiates a new SearchLines500Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSearchLines500Response(error_ string, retryable bool, id string) *SearchLines500Response {
	this := SearchLines500Response{}
	this.Error = error_
...
// NewSearchLines500ResponseWithDefaults instantiates a new SearchLines500Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSearchLines500ResponseWithDefaults() *SearchLines500Response {
	this := SearchLines500Response{}
	return &this
}

// GetError returns the Error field value
func (o *SearchLines500Response) GetError() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *SearchLines500Response) GetErrorOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Error, true
...
func (o *SearchLines500Response) SetError(v string) {
	o.Error = v
}

// GetRetryable returns the Retryable field value
func (o *SearchLines500Response) GetRetryable() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SearchLines500Response) GetRetryableOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SearchLines500Response) SetRetryable(v bool) {
	o.Retryable = v
}

// GetId returns the Id field value
func (o *SearchLines500Response) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SearchLines500Response) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *SearchLines500Response) SetId(v string) {
	o.Id = v
}

func (o SearchLines500Response) MarshalJSON() ([]byte, error) {
...
func (o SearchLines500Response) ToMap() (map[string]interface{}, error) {
...
func (o *SearchLines500Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSearchLines500Response := _SearchLines500Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSearchLines500Response)

	if err != nil {
		return err
	}

	*o = SearchLines500Response(varSearchLines500Response)

	return err
}

type NullableSearchLines500Response struct {
	value *SearchLines500Response
	isSet bool
}

func (v NullableSearchLines500Response) Get() *SearchLines500Response {
	return v.value
}

func (v *NullableSearchLines500Response) Set(val *SearchLines500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchLines500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchLines500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchLines500Response(val *SearchLines500Response) *NullableSearchLines500Response {
	return &NullableSearchLines500Response{value: val, isSet: true}
}

func (v NullableSearchLines500Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchLines500Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
