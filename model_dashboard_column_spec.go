...
// checks if the DashboardColumnSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DashboardColumnSpec{}

// DashboardColumnSpec struct for DashboardColumnSpec
type DashboardColumnSpec struct {
	Name string `json:"name"`
	Type string `json:"type"`
}

type _DashboardColumnSpec DashboardColumnSpec

// NewDashboardColumnSpec instantiates a new DashboardColumnSpec object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDashboardColumnSpec(name string, type_ string) *DashboardColumnSpec {
	this := DashboardColumnSpec{}
	this.Name = name
	this.Type = type_
	return &this
}

// NewDashboardColumnSpecWithDefaults instantiates a new DashboardColumnSpec object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDashboardColumnSpecWithDefaults() *DashboardColumnSpec {
	this := DashboardColumnSpec{}
	return &this
}

// GetName returns the Name field value
func (o *DashboardColumnSpec) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *DashboardColumnSpec) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *DashboardColumnSpec) SetName(v string) {
	o.Name = v
}

// GetType returns the Type field value
func (o *DashboardColumnSpec) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DashboardColumnSpec) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *DashboardColumnSpec) SetType(v string) {
	o.Type = v
}

func (o DashboardColumnSpec) MarshalJSON() ([]byte, error) {
...
func (o DashboardColumnSpec) ToMap() (map[string]interface{}, error) {
...
func (o *DashboardColumnSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varDashboardColumnSpec := _DashboardColumnSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDashboardColumnSpec)

	if err != nil {
		return err
	}

	*o = DashboardColumnSpec(varDashboardColumnSpec)

	return err
}

type NullableDashboardColumnSpec struct {
	value *DashboardColumnSpec
	isSet bool
}

func (v NullableDashboardColumnSpec) Get() *DashboardColumnSpec {
	return v.value
}

func (v *NullableDashboardColumnSpec) Set(val *DashboardColumnSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableDashboardColumnSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableDashboardColumnSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDashboardColumnSpec(val *DashboardColumnSpec) *NullableDashboardColumnSpec {
	return &NullableDashboardColumnSpec{value: val, isSet: true}
}

func (v NullableDashboardColumnSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDashboardColumnSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
