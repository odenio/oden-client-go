...
// checks if the DashboardExecuteFiltersStates type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DashboardExecuteFiltersStates{}

// DashboardExecuteFiltersStates struct for DashboardExecuteFiltersStates
type DashboardExecuteFiltersStates struct {
	StateTypes []string `json:"state_types,omitempty"`
	StateCategoryAndReasons []DashboardExecuteFiltersStatesStateCategoryAndReasonsInner `json:"state_category_and_reasons,omitempty"`
}

// NewDashboardExecuteFiltersStates instantiates a new DashboardExecuteFiltersStates object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDashboardExecuteFiltersStates() *DashboardExecuteFiltersStates {
	this := DashboardExecuteFiltersStates{}
	return &this
}

// NewDashboardExecuteFiltersStatesWithDefaults instantiates a new DashboardExecuteFiltersStates object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDashboardExecuteFiltersStatesWithDefaults() *DashboardExecuteFiltersStates {
	this := DashboardExecuteFiltersStates{}
	return &this
}

// GetStateTypes returns the StateTypes field value if set, zero value otherwise.
func (o *DashboardExecuteFiltersStates) GetStateTypes() []string {
	if o == nil || IsNil(o.StateTypes) {
		var ret []string
		return ret
	}
	return o.StateTypes
...
// GetStateTypesOk returns a tuple with the StateTypes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DashboardExecuteFiltersStates) GetStateTypesOk() ([]string, bool) {
	if o == nil || IsNil(o.StateTypes) {
		return nil, false
	}
	return o.StateTypes, true
}

// HasStateTypes returns a boolean if a field has been set.
func (o *DashboardExecuteFiltersStates) HasStateTypes() bool {
	if o != nil && !IsNil(o.StateTypes) {
		return true
	}
...
// SetStateTypes gets a reference to the given []string and assigns it to the StateTypes field.
func (o *DashboardExecuteFiltersStates) SetStateTypes(v []string) {
	o.StateTypes = v
}

// GetStateCategoryAndReasons returns the StateCategoryAndReasons field value if set, zero value otherwise.
func (o *DashboardExecuteFiltersStates) GetStateCategoryAndReasons() []DashboardExecuteFiltersStatesStateCategoryAndReasonsInner {
	if o == nil || IsNil(o.StateCategoryAndReasons) {
		var ret []DashboardExecuteFiltersStatesStateCategoryAndReasonsInner
		return ret
	}
	return o.StateCategoryAndReasons
}

// GetStateCategoryAndReasonsOk returns a tuple with the StateCategoryAndReasons field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DashboardExecuteFiltersStates) GetStateCategoryAndReasonsOk() ([]DashboardExecuteFiltersStatesStateCategoryAndReasonsInner, bool) {
	if o == nil || IsNil(o.StateCategoryAndReasons) {
		return nil, false
	}
	return o.StateCategoryAndReasons, true
}

// HasStateCategoryAndReasons returns a boolean if a field has been set.
func (o *DashboardExecuteFiltersStates) HasStateCategoryAndReasons() bool {
	if o != nil && !IsNil(o.StateCategoryAndReasons) {
		return true
	}
...
// SetStateCategoryAndReasons gets a reference to the given []DashboardExecuteFiltersStatesStateCategoryAndReasonsInner and assigns it to the StateCategoryAndReasons field.
func (o *DashboardExecuteFiltersStates) SetStateCategoryAndReasons(v []DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) {
	o.StateCategoryAndReasons = v
}

func (o DashboardExecuteFiltersStates) MarshalJSON() ([]byte, error) {
...
func (o DashboardExecuteFiltersStates) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.StateTypes) {
		toSerialize["state_types"] = o.StateTypes
	}
	if !IsNil(o.StateCategoryAndReasons) {
		toSerialize["state_category_and_reasons"] = o.StateCategoryAndReasons
	}
	return toSerialize, nil
}

type NullableDashboardExecuteFiltersStates struct {
	value *DashboardExecuteFiltersStates
	isSet bool
}

func (v NullableDashboardExecuteFiltersStates) Get() *DashboardExecuteFiltersStates {
	return v.value
}

func (v *NullableDashboardExecuteFiltersStates) Set(val *DashboardExecuteFiltersStates) {
	v.value = val
	v.isSet = true
}

func (v NullableDashboardExecuteFiltersStates) IsSet() bool {
	return v.isSet
}

func (v *NullableDashboardExecuteFiltersStates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDashboardExecuteFiltersStates(val *DashboardExecuteFiltersStates) *NullableDashboardExecuteFiltersStates {
	return &NullableDashboardExecuteFiltersStates{value: val, isSet: true}
}

func (v NullableDashboardExecuteFiltersStates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDashboardExecuteFiltersStates) UnmarshalJSON(src []byte) error {
	v.isSet = true
