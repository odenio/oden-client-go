...
// checks if the IntervalType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntervalType{}

// IntervalType An object representing a interval type.
...
func (o IntervalType) MarshalJSON() ([]byte, error) {
...
func (o IntervalType) ToMap() (map[string]interface{}, error) {
