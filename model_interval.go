...
// Interval An object representing an interval of time on a line and associated metadata.
...
// SetMetadata gets a reference to the given IntervalMetadata and assigns it to the Metadata field.
