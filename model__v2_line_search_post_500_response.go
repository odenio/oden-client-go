...
// checks if the V2LineSearchPost500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2LineSearchPost500Response{}

// V2LineSearchPost500Response struct for V2LineSearchPost500Response
type V2LineSearchPost500Response struct {
	Error string `json:"error"`
	Retryable bool `json:"retryable"`
	Id string `json:"id"`
}

type _V2LineSearchPost500Response V2LineSearchPost500Response
...
func NewV2LineSearchPost500Response(error_ string, retryable bool, id string) *V2LineSearchPost500Response {
	this := V2LineSearchPost500Response{}
	this.Error = error_
...
func (o V2LineSearchPost500Response) MarshalJSON() ([]byte, error) {
...
func (o V2LineSearchPost500Response) ToMap() (map[string]interface{}, error) {
...
func (o *V2LineSearchPost500Response) UnmarshalJSON(data []byte) (err error) {
	...
	varV2LineSearchPost500Response := _V2LineSearchPost500Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV2LineSearchPost500Response)

	if err != nil {
		return err
	}

	*o = V2LineSearchPost500Response(varV2LineSearchPost500Response)

	return err
}

type NullableV2LineSearchPost500Response struct {
	value *V2LineSearchPost500Response
	isSet bool
}

func (v NullableV2LineSearchPost500Response) Get() *V2LineSearchPost500Response {
	return v.value
}

func (v *NullableV2LineSearchPost500Response) Set(val *V2LineSearchPost500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2LineSearchPost500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2LineSearchPost500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2LineSearchPost500Response(val *V2LineSearchPost500Response) *NullableV2LineSearchPost500Response {
	return &NullableV2LineSearchPost500Response{value: val, isSet: true}
}

func (v NullableV2LineSearchPost500Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2LineSearchPost500Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
