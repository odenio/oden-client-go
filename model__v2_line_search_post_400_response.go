...
// checks if the V2LineSearchPost400Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2LineSearchPost400Response{}

// V2LineSearchPost400Response struct for V2LineSearchPost400Response
type V2LineSearchPost400Response struct {
	Error string `json:"error"`
	Name string `json:"name"`
	Retryable bool `json:"retryable"`
}

type _V2LineSearchPost400Response V2LineSearchPost400Response
...
func NewV2LineSearchPost400Response(error_ string, name string, retryable bool) *V2LineSearchPost400Response {
	this := V2LineSearchPost400Response{}
	this.Error = error_
	this.Name = name
...
func (o V2LineSearchPost400Response) MarshalJSON() ([]byte, error) {
...
func (o V2LineSearchPost400Response) ToMap() (map[string]interface{}, error) {
...
func (o *V2LineSearchPost400Response) UnmarshalJSON(data []byte) (err error) {
	...
	varV2LineSearchPost400Response := _V2LineSearchPost400Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV2LineSearchPost400Response)

	if err != nil {
		return err
	}

	*o = V2LineSearchPost400Response(varV2LineSearchPost400Response)

	return err
}

type NullableV2LineSearchPost400Response struct {
	value *V2LineSearchPost400Response
	isSet bool
}

func (v NullableV2LineSearchPost400Response) Get() *V2LineSearchPost400Response {
	return v.value
}

func (v *NullableV2LineSearchPost400Response) Set(val *V2LineSearchPost400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2LineSearchPost400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2LineSearchPost400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2LineSearchPost400Response(val *V2LineSearchPost400Response) *NullableV2LineSearchPost400Response {
	return &NullableV2LineSearchPost400Response{value: val, isSet: true}
}

func (v NullableV2LineSearchPost400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2LineSearchPost400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
