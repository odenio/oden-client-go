...
// checks if the DashboardExecuteFiltersCustomIntervalsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DashboardExecuteFiltersCustomIntervalsInner{}

// DashboardExecuteFiltersCustomIntervalsInner struct for DashboardExecuteFiltersCustomIntervalsInner
type DashboardExecuteFiltersCustomIntervalsInner struct {
	Type string `json:"type"`
	ValueContains string `json:"value_contains"`
}

type _DashboardExecuteFiltersCustomIntervalsInner DashboardExecuteFiltersCustomIntervalsInner

// NewDashboardExecuteFiltersCustomIntervalsInner instantiates a new DashboardExecuteFiltersCustomIntervalsInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDashboardExecuteFiltersCustomIntervalsInner(type_ string, valueContains string) *DashboardExecuteFiltersCustomIntervalsInner {
	this := DashboardExecuteFiltersCustomIntervalsInner{}
	this.Type = type_
	this.ValueContains = valueContains
	return &this
}

// NewDashboardExecuteFiltersCustomIntervalsInnerWithDefaults instantiates a new DashboardExecuteFiltersCustomIntervalsInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDashboardExecuteFiltersCustomIntervalsInnerWithDefaults() *DashboardExecuteFiltersCustomIntervalsInner {
	this := DashboardExecuteFiltersCustomIntervalsInner{}
	return &this
}

// GetType returns the Type field value
func (o *DashboardExecuteFiltersCustomIntervalsInner) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *DashboardExecuteFiltersCustomIntervalsInner) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *DashboardExecuteFiltersCustomIntervalsInner) SetType(v string) {
	o.Type = v
}

// GetValueContains returns the ValueContains field value
func (o *DashboardExecuteFiltersCustomIntervalsInner) GetValueContains() string {
	if o == nil {
		var ret string
		return ret
	}

	return o.ValueContains
}

// GetValueContainsOk returns a tuple with the ValueContains field value
// and a boolean to check if the value has been set.
func (o *DashboardExecuteFiltersCustomIntervalsInner) GetValueContainsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ValueContains, true
}

// SetValueContains sets field value
func (o *DashboardExecuteFiltersCustomIntervalsInner) SetValueContains(v string) {
	o.ValueContains = v
}

func (o DashboardExecuteFiltersCustomIntervalsInner) MarshalJSON() ([]byte, error) {
...
func (o DashboardExecuteFiltersCustomIntervalsInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["type"] = o.Type
	toSerialize["value_contains"] = o.ValueContains
	return toSerialize, nil
}

func (o *DashboardExecuteFiltersCustomIntervalsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varDashboardExecuteFiltersCustomIntervalsInner := _DashboardExecuteFiltersCustomIntervalsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDashboardExecuteFiltersCustomIntervalsInner)

	if err != nil {
		return err
	}

	*o = DashboardExecuteFiltersCustomIntervalsInner(varDashboardExecuteFiltersCustomIntervalsInner)

	return err
}

type NullableDashboardExecuteFiltersCustomIntervalsInner struct {
	value *DashboardExecuteFiltersCustomIntervalsInner
	isSet bool
}

func (v NullableDashboardExecuteFiltersCustomIntervalsInner) Get() *DashboardExecuteFiltersCustomIntervalsInner {
	return v.value
}

func (v *NullableDashboardExecuteFiltersCustomIntervalsInner) Set(val *DashboardExecuteFiltersCustomIntervalsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDashboardExecuteFiltersCustomIntervalsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDashboardExecuteFiltersCustomIntervalsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDashboardExecuteFiltersCustomIntervalsInner(val *DashboardExecuteFiltersCustomIntervalsInner) *NullableDashboardExecuteFiltersCustomIntervalsInner {
	return &NullableDashboardExecuteFiltersCustomIntervalsInner{value: val, isSet: true}
}

func (v NullableDashboardExecuteFiltersCustomIntervalsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDashboardExecuteFiltersCustomIntervalsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
