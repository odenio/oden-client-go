...
// checks if the IntervalBulkCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntervalBulkCreate{}

// IntervalBulkCreate A set of intervals to create
type IntervalBulkCreate struct {
...
func (o IntervalBulkCreate) MarshalJSON() ([]byte, error) {
...
func (o IntervalBulkCreate) ToMap() (map[string]interface{}, error) {
...
type NullableIntervalBulkCreate struct {
	value *IntervalBulkCreate
	isSet bool
}

func (v NullableIntervalBulkCreate) Get() *IntervalBulkCreate {
	return v.value
}

func (v *NullableIntervalBulkCreate) Set(val *IntervalBulkCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableIntervalBulkCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableIntervalBulkCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntervalBulkCreate(val *IntervalBulkCreate) *NullableIntervalBulkCreate {
	return &NullableIntervalBulkCreate{value: val, isSet: true}
}

func (v NullableIntervalBulkCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntervalBulkCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
