...
// checks if the BulkDeleteIntervals200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkDeleteIntervals200Response{}

// BulkDeleteIntervals200Response struct for BulkDeleteIntervals200Response
type BulkDeleteIntervals200Response struct {
...
func NewBulkDeleteIntervals200Response() *BulkDeleteIntervals200Response {
	this := BulkDeleteIntervals200Response{}
	return &this
}
...
func (o BulkDeleteIntervals200Response) MarshalJSON() ([]byte, error) {
...
func (o BulkDeleteIntervals200Response) ToMap() (map[string]interface{}, error) {
...
type NullableBulkDeleteIntervals200Response struct {
	value *BulkDeleteIntervals200Response
	isSet bool
}

func (v NullableBulkDeleteIntervals200Response) Get() *BulkDeleteIntervals200Response {
	return v.value
}

func (v *NullableBulkDeleteIntervals200Response) Set(val *BulkDeleteIntervals200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkDeleteIntervals200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkDeleteIntervals200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkDeleteIntervals200Response(val *BulkDeleteIntervals200Response) *NullableBulkDeleteIntervals200Response {
	return &NullableBulkDeleteIntervals200Response{value: val, isSet: true}
}

func (v NullableBulkDeleteIntervals200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkDeleteIntervals200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
