...
// checks if the DashboardExecuteResultRange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DashboardExecuteResultRange{}

// DashboardExecuteResultRange Resolved absolute time window the executed query actually covers. For relative requests this is the concrete window the anchor/offset resolved to. 
type DashboardExecuteResultRange struct {
	Start *time.Time `json:"start,omitempty"`
	End *time.Time `json:"end,omitempty"`
}

// NewDashboardExecuteResultRange instantiates a new DashboardExecuteResultRange object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDashboardExecuteResultRange() *DashboardExecuteResultRange {
	this := DashboardExecuteResultRange{}
	return &this
}

// NewDashboardExecuteResultRangeWithDefaults instantiates a new DashboardExecuteResultRange object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDashboardExecuteResultRangeWithDefaults() *DashboardExecuteResultRange {
	this := DashboardExecuteResultRange{}
	return &this
}

// GetStart returns the Start field value if set, zero value otherwise.
func (o *DashboardExecuteResultRange) GetStart() time.Time {
...
func (o *DashboardExecuteResultRange) GetStartOk() (*time.Time, bool) {
	if o == nil || IsNil(o.Start) {
		return nil, false
	}
	return o.Start, true
...
func (o *DashboardExecuteResultRange) HasStart() bool {
	if o != nil && !IsNil(o.Start) {
		return true
	}
...
func (o *DashboardExecuteResultRange) SetStart(v time.Time) {
	o.Start = &v
}

// GetEnd returns the End field value if set, zero value otherwise.
func (o *DashboardExecuteResultRange) GetEnd() time.Time {
...
// and a boolean to check if the value has been set.
func (o *DashboardExecuteResultRange) GetEndOk() (*time.Time, bool) {
	if o == nil || IsNil(o.End) {
		return nil, false
	}
	return o.End, true
...
func (o *DashboardExecuteResultRange) HasEnd() bool {
	if o != nil && !IsNil(o.End) {
		return true
	}
...
func (o *DashboardExecuteResultRange) SetEnd(v time.Time) {
	o.End = &v
}

func (o DashboardExecuteResultRange) MarshalJSON() ([]byte, error) {
...
func (o DashboardExecuteResultRange) ToMap() (map[string]interface{}, error) {
...
type NullableDashboardExecuteResultRange struct {
	value *DashboardExecuteResultRange
	isSet bool
}

func (v NullableDashboardExecuteResultRange) Get() *DashboardExecuteResultRange {
	return v.value
}

func (v *NullableDashboardExecuteResultRange) Set(val *DashboardExecuteResultRange) {
	v.value = val
	v.isSet = true
}

func (v NullableDashboardExecuteResultRange) IsSet() bool {
	return v.isSet
}

func (v *NullableDashboardExecuteResultRange) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDashboardExecuteResultRange(val *DashboardExecuteResultRange) *NullableDashboardExecuteResultRange {
	return &NullableDashboardExecuteResultRange{value: val, isSet: true}
}

func (v NullableDashboardExecuteResultRange) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDashboardExecuteResultRange) UnmarshalJSON(src []byte) error {
	v.isSet = true
