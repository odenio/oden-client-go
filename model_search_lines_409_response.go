...
// checks if the SearchLines409Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchLines409Response{}

// SearchLines409Response struct for SearchLines409Response
type SearchLines409Response struct {
...
type _SearchLines409Response SearchLines409Response
...
func (o SearchLines409Response) MarshalJSON() ([]byte, error) {
...
func (o SearchLines409Response) ToMap() (map[string]interface{}, error) {
...
func (o *SearchLines409Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSearchLines409Response := _SearchLines409Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSearchLines409Response)

	if err != nil {
		return err
	}

	*o = SearchLines409Response(varSearchLines409Response)

	return err
}

type NullableSearchLines409Response struct {
	value *SearchLines409Response
	isSet bool
}

func (v NullableSearchLines409Response) Get() *SearchLines409Response {
	return v.value
}

func (v *NullableSearchLines409Response) Set(val *SearchLines409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchLines409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchLines409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchLines409Response(val *SearchLines409Response) *NullableSearchLines409Response {
	return &NullableSearchLines409Response{value: val, isSet: true}
}

func (v NullableSearchLines409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchLines409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
