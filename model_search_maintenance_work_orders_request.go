...
// checks if the SearchMaintenanceWorkOrdersRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchMaintenanceWorkOrdersRequest{}

// SearchMaintenanceWorkOrdersRequest struct for SearchMaintenanceWorkOrdersRequest
type SearchMaintenanceWorkOrdersRequest struct {
...
func NewSearchMaintenanceWorkOrdersRequest() *SearchMaintenanceWorkOrdersRequest {
	this := SearchMaintenanceWorkOrdersRequest{}
...
func (o SearchMaintenanceWorkOrdersRequest) MarshalJSON() ([]byte, error) {
...
func (o SearchMaintenanceWorkOrdersRequest) ToMap() (map[string]interface{}, error) {
...
type NullableSearchMaintenanceWorkOrdersRequest struct {
	value *SearchMaintenanceWorkOrdersRequest
	isSet bool
}

func (v NullableSearchMaintenanceWorkOrdersRequest) Get() *SearchMaintenanceWorkOrdersRequest {
	return v.value
}

func (v *NullableSearchMaintenanceWorkOrdersRequest) Set(val *SearchMaintenanceWorkOrdersRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchMaintenanceWorkOrdersRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchMaintenanceWorkOrdersRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchMaintenanceWorkOrdersRequest(val *SearchMaintenanceWorkOrdersRequest) *NullableSearchMaintenanceWorkOrdersRequest {
	return &NullableSearchMaintenanceWorkOrdersRequest{value: val, isSet: true}
}

func (v NullableSearchMaintenanceWorkOrdersRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchMaintenanceWorkOrdersRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
