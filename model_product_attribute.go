...
// ProductAttribute An entity representing an attribute of a product such as a color or material 
type ProductAttribute struct {
	...
	RuleBased *bool `json:"rule_based,omitempty"`
...
// GetRuleBased returns the RuleBased field value if set, zero value otherwise.
func (o *ProductAttribute) GetRuleBased() bool {
	if o == nil || IsNil(o.RuleBased) {
		var ret bool
		return ret
	}
	return *o.RuleBased
...
// GetRuleBasedOk returns a tuple with the RuleBased field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProductAttribute) GetRuleBasedOk() (*bool, bool) {
	if o == nil || IsNil(o.RuleBased) {
		return nil, false
	}
	return o.RuleBased, true
}
...
// SetRuleBased gets a reference to the given bool and assigns it to the RuleBased field.
...
func (o ProductAttribute) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RuleBased) {
		toSerialize["rule_based"] = o.RuleBased
	}
	if !IsNil(o.Match) {
