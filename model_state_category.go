...
// checks if the StateCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StateCategory{}

// StateCategory An entity representing a state category. During search, ID will take precedence over name.
...
func (o StateCategory) MarshalJSON() ([]byte, error) {
...
func (o StateCategory) ToMap() (map[string]interface{}, error) {
...
type NullableStateCategory struct {
	value *StateCategory
	isSet bool
}

func (v NullableStateCategory) Get() *StateCategory {
	return v.value
}

func (v *NullableStateCategory) Set(val *StateCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableStateCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableStateCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStateCategory(val *StateCategory) *NullableStateCategory {
	return &NullableStateCategory{value: val, isSet: true}
}

func (v NullableStateCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStateCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
