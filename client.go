...
// APIClient manages communication with the Oden API API v2.0.0
...
type APIClient struct {
	...
	IntervalsAPI *IntervalsAPIService

	MachineGroupsAPI *MachineGroupsAPIService

	MaintenanceWorkOrdersAPI *MaintenanceWorkOrdersAPIService

	MetricGroupsAPI *MetricGroupsAPIService

	OQLAPI *OQLAPIService

	ProductAttributesAPI *ProductAttributesAPIService

	ProductMappingsAPI *ProductMappingsAPIService

	ProductsAPI *ProductsAPIService

	QualityTestAPI *QualityTestAPIService

	ScrapYieldDataAPI *ScrapYieldDataAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.IntervalsAPI = (*IntervalsAPIService)(&c.common)
	c.MachineGroupsAPI = (*MachineGroupsAPIService)(&c.common)
	c.MaintenanceWorkOrdersAPI = (*MaintenanceWorkOrdersAPIService)(&c.common)
	c.MetricGroupsAPI = (*MetricGroupsAPIService)(&c.common)
	c.OQLAPI = (*OQLAPIService)(&c.common)
	c.ProductAttributesAPI = (*ProductAttributesAPIService)(&c.common)
	c.ProductMappingsAPI = (*ProductMappingsAPIService)(&c.common)
	c.ProductsAPI = (*ProductsAPIService)(&c.common)
	c.QualityTestAPI = (*QualityTestAPIService)(&c.common)
	c.ScrapYieldDataAPI = (*ScrapYieldDataAPIService)(&c.common)
