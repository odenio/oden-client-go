...
// checks if the StateReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StateReason{}

// StateReason An entity representing a state reason. During search, ID will take precedence over name.
...
func (o StateReason) ToMap() (map[string]interface{}, error) {
...
type NullableStateReason struct {
	value *StateReason
	isSet bool
}

func (v NullableStateReason) Get() *StateReason {
	return v.value
}

func (v *NullableStateReason) Set(val *StateReason) {
	v.value = val
	v.isSet = true
}

func (v NullableStateReason) IsSet() bool {
	return v.isSet
}

func (v *NullableStateReason) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStateReason(val *StateReason) *NullableStateReason {
	return &NullableStateReason{value: val, isSet: true}
}

func (v NullableStateReason) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStateReason) UnmarshalJSON(src []byte) error {
	v.isSet = true
