...
// checks if the DashboardExecuteFiltersStatesStateCategoryAndReasonsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DashboardExecuteFiltersStatesStateCategoryAndReasonsInner{}

// DashboardExecuteFiltersStatesStateCategoryAndReasonsInner struct for DashboardExecuteFiltersStatesStateCategoryAndReasonsInner
type DashboardExecuteFiltersStatesStateCategoryAndReasonsInner struct {
	StateCategory int32 `json:"state_category"`
	StateReason *string `json:"state_reason,omitempty"`
}

type _DashboardExecuteFiltersStatesStateCategoryAndReasonsInner DashboardExecuteFiltersStatesStateCategoryAndReasonsInner

// NewDashboardExecuteFiltersStatesStateCategoryAndReasonsInner instantiates a new DashboardExecuteFiltersStatesStateCategoryAndReasonsInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDashboardExecuteFiltersStatesStateCategoryAndReasonsInner(stateCategory int32) *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner {
	this := DashboardExecuteFiltersStatesStateCategoryAndReasonsInner{}
	this.StateCategory = stateCategory
	return &this
}

// NewDashboardExecuteFiltersStatesStateCategoryAndReasonsInnerWithDefaults instantiates a new DashboardExecuteFiltersStatesStateCategoryAndReasonsInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDashboardExecuteFiltersStatesStateCategoryAndReasonsInnerWithDefaults() *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner {
	this := DashboardExecuteFiltersStatesStateCategoryAndReasonsInner{}
	return &this
}

// GetStateCategory returns the StateCategory field value
func (o *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) GetStateCategory() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) GetStateCategoryOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) SetStateCategory(v int32) {
	o.StateCategory = v
}

// GetStateReason returns the StateReason field value if set, zero value otherwise.
func (o *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) GetStateReason() string {
...
// and a boolean to check if the value has been set.
func (o *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) GetStateReasonOk() (*string, bool) {
	if o == nil || IsNil(o.StateReason) {
		return nil, false
	}
...
func (o *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) HasStateReason() bool {
	if o != nil && !IsNil(o.StateReason) {
		return true
	}
...
func (o *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) SetStateReason(v string) {
	o.StateReason = &v
}

func (o DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) MarshalJSON() ([]byte, error) {
...
func (o DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) ToMap() (map[string]interface{}, error) {
...
func (o *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varDashboardExecuteFiltersStatesStateCategoryAndReasonsInner := _DashboardExecuteFiltersStatesStateCategoryAndReasonsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDashboardExecuteFiltersStatesStateCategoryAndReasonsInner)

	if err != nil {
		return err
	}

	*o = DashboardExecuteFiltersStatesStateCategoryAndReasonsInner(varDashboardExecuteFiltersStatesStateCategoryAndReasonsInner)

	return err
}

type NullableDashboardExecuteFiltersStatesStateCategoryAndReasonsInner struct {
	value *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner
	isSet bool
}

func (v NullableDashboardExecuteFiltersStatesStateCategoryAndReasonsInner) Get() *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner {
	return v.value
}

func (v *NullableDashboardExecuteFiltersStatesStateCategoryAndReasonsInner) Set(val *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDashboardExecuteFiltersStatesStateCategoryAndReasonsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDashboardExecuteFiltersStatesStateCategoryAndReasonsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDashboardExecuteFiltersStatesStateCategoryAndReasonsInner(val *DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) *NullableDashboardExecuteFiltersStatesStateCategoryAndReasonsInner {
	return &NullableDashboardExecuteFiltersStatesStateCategoryAndReasonsInner{value: val, isSet: true}
}

func (v NullableDashboardExecuteFiltersStatesStateCategoryAndReasonsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDashboardExecuteFiltersStatesStateCategoryAndReasonsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
