...
// checks if the V2IntervalsSetPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2IntervalsSetPost200Response{}

// V2IntervalsSetPost200Response struct for V2IntervalsSetPost200Response
type V2IntervalsSetPost200Response struct {
...
func NewV2IntervalsSetPost200Response() *V2IntervalsSetPost200Response {
	this := V2IntervalsSetPost200Response{}
	return &this
}
...
// GetIntervalIds returns the IntervalIds field value if set, zero value otherwise.
func (o *V2IntervalsSetPost200Response) GetIntervalIds() []string {
	if o == nil || IsNil(o.IntervalIds) {
		var ret []string
		return ret
	}
	return o.IntervalIds
}

// GetIntervalIdsOk returns a tuple with the IntervalIds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V2IntervalsSetPost200Response) GetIntervalIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.IntervalIds) {
		return nil, false
	}
	return o.IntervalIds, true
}
...
// SetIntervalIds gets a reference to the given []string and assigns it to the IntervalIds field.
func (o *V2IntervalsSetPost200Response) SetIntervalIds(v []string) {
	o.IntervalIds = v
}

func (o V2IntervalsSetPost200Response) MarshalJSON() ([]byte, error) {
...
func (o V2IntervalsSetPost200Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.IntervalIds) {
		toSerialize["interval_ids"] = o.IntervalIds
	}
	return toSerialize, nil
}

type NullableV2IntervalsSetPost200Response struct {
	value *V2IntervalsSetPost200Response
	isSet bool
}

func (v NullableV2IntervalsSetPost200Response) Get() *V2IntervalsSetPost200Response {
	return v.value
}

func (v *NullableV2IntervalsSetPost200Response) Set(val *V2IntervalsSetPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2IntervalsSetPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2IntervalsSetPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2IntervalsSetPost200Response(val *V2IntervalsSetPost200Response) *NullableV2IntervalsSetPost200Response {
	return &NullableV2IntervalsSetPost200Response{value: val, isSet: true}
}

func (v NullableV2IntervalsSetPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2IntervalsSetPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
