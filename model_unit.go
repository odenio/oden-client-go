...
// Unit A Unit describes a unit of measurement. 
type Unit struct {
	Id *int32 `json:"id,omitempty"`
	Symbol *string `json:"symbol,omitempty"`
	Name *string `json:"name,omitempty"`
	KindOfQuantity *string `json:"kind_of_quantity,omitempty"`
}
...
// GetKindOfQuantity returns the KindOfQuantity field value if set, zero value otherwise.
func (o *Unit) GetKindOfQuantity() string {
	if o == nil || IsNil(o.KindOfQuantity) {
		var ret string
		return ret
	}
	return *o.KindOfQuantity
}

// GetKindOfQuantityOk returns a tuple with the KindOfQuantity field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Unit) GetKindOfQuantityOk() (*string, bool) {
	if o == nil || IsNil(o.KindOfQuantity) {
		return nil, false
	}
	return o.KindOfQuantity, true
}
...
// SetKindOfQuantity gets a reference to the given string and assigns it to the KindOfQuantity field.
...
func (o Unit) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.KindOfQuantity) {
		toSerialize["kind_of_quantity"] = o.KindOfQuantity
	}
