...
// checks if the V2ScrapYieldSearchPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ScrapYieldSearchPostRequest{}

// V2ScrapYieldSearchPostRequest struct for V2ScrapYieldSearchPostRequest
type V2ScrapYieldSearchPostRequest struct {
	Data *ScrapYieldData `json:"data,omitempty"`
	Interval Interval `json:"interval"`
}

type _V2ScrapYieldSearchPostRequest V2ScrapYieldSearchPostRequest
...
func NewV2ScrapYieldSearchPostRequest(interval Interval) *V2ScrapYieldSearchPostRequest {
	this := V2ScrapYieldSearchPostRequest{}
...
// SetData gets a reference to the given ScrapYieldData and assigns it to the Data field.
...
func (o V2ScrapYieldSearchPostRequest) MarshalJSON() ([]byte, error) {
...
func (o V2ScrapYieldSearchPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *V2ScrapYieldSearchPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varV2ScrapYieldSearchPostRequest := _V2ScrapYieldSearchPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV2ScrapYieldSearchPostRequest)

	if err != nil {
		return err
	}

	*o = V2ScrapYieldSearchPostRequest(varV2ScrapYieldSearchPostRequest)

	return err
}

type NullableV2ScrapYieldSearchPostRequest struct {
	value *V2ScrapYieldSearchPostRequest
	isSet bool
}

func (v NullableV2ScrapYieldSearchPostRequest) Get() *V2ScrapYieldSearchPostRequest {
	return v.value
}

func (v *NullableV2ScrapYieldSearchPostRequest) Set(val *V2ScrapYieldSearchPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ScrapYieldSearchPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ScrapYieldSearchPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ScrapYieldSearchPostRequest(val *V2ScrapYieldSearchPostRequest) *NullableV2ScrapYieldSearchPostRequest {
	return &NullableV2ScrapYieldSearchPostRequest{value: val, isSet: true}
}

func (v NullableV2ScrapYieldSearchPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ScrapYieldSearchPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
