...
// checks if the DashboardExecuteRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DashboardExecuteRequest{}

// DashboardExecuteRequest Request envelope for executing every module in a dashboard. 
type DashboardExecuteRequest struct {
	Dashboard DashboardExecuteRequestDashboard `json:"dashboard"`
	Range *DashboardExecuteRange `json:"range,omitempty"`
	Filters *DashboardExecuteFilters `json:"filters,omitempty"`
}

type _DashboardExecuteRequest DashboardExecuteRequest
...
func (o *DashboardExecuteRequest) GetDashboard() DashboardExecuteRequestDashboard {
	if o == nil {
		var ret DashboardExecuteRequestDashboard
		return ret
	}
...
// SetRange gets a reference to the given DashboardExecuteRange and assigns it to the Range field.
...
func (o *DashboardExecuteRequest) GetFilters() DashboardExecuteFilters {
	if o == nil || IsNil(o.Filters) {
		var ret DashboardExecuteFilters
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given DashboardExecuteFilters and assigns it to the Filters field.
func (o *DashboardExecuteRequest) SetFilters(v DashboardExecuteFilters) {
	o.Filters = &v
}

func (o DashboardExecuteRequest) MarshalJSON() ([]byte, error) {
...
func (o DashboardExecuteRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DashboardExecuteRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDashboardExecuteRequest := _DashboardExecuteRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDashboardExecuteRequest)

	if err != nil {
		return err
	}

	*o = DashboardExecuteRequest(varDashboardExecuteRequest)

	return err
}

type NullableDashboardExecuteRequest struct {
	value *DashboardExecuteRequest
	isSet bool
}

func (v NullableDashboardExecuteRequest) Get() *DashboardExecuteRequest {
	return v.value
}

func (v *NullableDashboardExecuteRequest) Set(val *DashboardExecuteRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDashboardExecuteRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDashboardExecuteRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDashboardExecuteRequest(val *DashboardExecuteRequest) *NullableDashboardExecuteRequest {
	return &NullableDashboardExecuteRequest{value: val, isSet: true}
}

func (v NullableDashboardExecuteRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDashboardExecuteRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
