...
// checks if the BulkDeleteQualityTestsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkDeleteQualityTestsRequest{}

// BulkDeleteQualityTestsRequest struct for BulkDeleteQualityTestsRequest
type BulkDeleteQualityTestsRequest struct {
...
func NewBulkDeleteQualityTestsRequest() *BulkDeleteQualityTestsRequest {
	this := BulkDeleteQualityTestsRequest{}
	return &this
}
...
func (o BulkDeleteQualityTestsRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkDeleteQualityTestsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableBulkDeleteQualityTestsRequest struct {
	value *BulkDeleteQualityTestsRequest
	isSet bool
}

func (v NullableBulkDeleteQualityTestsRequest) Get() *BulkDeleteQualityTestsRequest {
	return v.value
}

func (v *NullableBulkDeleteQualityTestsRequest) Set(val *BulkDeleteQualityTestsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkDeleteQualityTestsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkDeleteQualityTestsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkDeleteQualityTestsRequest(val *BulkDeleteQualityTestsRequest) *NullableBulkDeleteQualityTestsRequest {
	return &NullableBulkDeleteQualityTestsRequest{value: val, isSet: true}
}

func (v NullableBulkDeleteQualityTestsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkDeleteQualityTestsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
