...
// checks if the IntervalBulkDelete type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntervalBulkDelete{}

// IntervalBulkDelete A range of intervals to delete
type IntervalBulkDelete struct {
...
func NewIntervalBulkDelete() *IntervalBulkDelete {
	this := IntervalBulkDelete{}
	var hardDelete bool = true
...
// SetType gets a reference to the given IntervalType and assigns it to the Type field.
...
func (o IntervalBulkDelete) MarshalJSON() ([]byte, error) {
...
func (o IntervalBulkDelete) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.HardDelete) {
		toSerialize["hard_delete"] = o.HardDelete
	}
	return toSerialize, nil
}

type NullableIntervalBulkDelete struct {
	value *IntervalBulkDelete
	isSet bool
}

func (v NullableIntervalBulkDelete) Get() *IntervalBulkDelete {
	return v.value
}

func (v *NullableIntervalBulkDelete) Set(val *IntervalBulkDelete) {
	v.value = val
	v.isSet = true
}

func (v NullableIntervalBulkDelete) IsSet() bool {
	return v.isSet
}

func (v *NullableIntervalBulkDelete) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntervalBulkDelete(val *IntervalBulkDelete) *NullableIntervalBulkDelete {
	return &NullableIntervalBulkDelete{value: val, isSet: true}
}

func (v NullableIntervalBulkDelete) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntervalBulkDelete) UnmarshalJSON(src []byte) error {
	v.isSet = true
