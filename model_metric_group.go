...
// checks if the MetricGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricGroup{}

// MetricGroup An object representing a metric group; a grouping of like metrics across lines, factories.
type MetricGroup struct {
	Name *string `json:"name,omitempty"`
	Description *string `json:"description,omitempty"`
	Id *string `json:"id,omitempty"`
	UnitKindOfQuantity *string `json:"unit_kind_of_quantity,omitempty"`
...
// GetUnitKindOfQuantity returns the UnitKindOfQuantity field value if set, zero value otherwise.
func (o *MetricGroup) GetUnitKindOfQuantity() string {
	if o == nil || IsNil(o.UnitKindOfQuantity) {
		var ret string
		return ret
	}
	return *o.UnitKindOfQuantity
}

// GetUnitKindOfQuantityOk returns a tuple with the UnitKindOfQuantity field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MetricGroup) GetUnitKindOfQuantityOk() (*string, bool) {
	if o == nil || IsNil(o.UnitKindOfQuantity) {
		return nil, false
	}
	return o.UnitKindOfQuantity, true
}
...
// SetUnitKindOfQuantity gets a reference to the given string and assigns it to the UnitKindOfQuantity field.
func (o *MetricGroup) SetUnitKindOfQuantity(v string) {
	o.UnitKindOfQuantity = &v
}
...
func (o MetricGroup) MarshalJSON() ([]byte, error) {
...
func (o MetricGroup) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UnitKindOfQuantity) {
		toSerialize["unit_kind_of_quantity"] = o.UnitKindOfQuantity
	}
	if !IsNil(o.Match) {
