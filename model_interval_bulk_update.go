...
// checks if the IntervalBulkUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntervalBulkUpdate{}

// IntervalBulkUpdate A set of intervals to update
type IntervalBulkUpdate struct {
...
// SetIntervals gets a reference to the given []Interval and assigns it to the Intervals field.
func (o *IntervalBulkUpdate) SetIntervals(v []Interval) {
	o.Intervals = v
}

func (o IntervalBulkUpdate) MarshalJSON() ([]byte, error) {
...
func (o IntervalBulkUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableIntervalBulkUpdate struct {
	value *IntervalBulkUpdate
	isSet bool
}

func (v NullableIntervalBulkUpdate) Get() *IntervalBulkUpdate {
	return v.value
}

func (v *NullableIntervalBulkUpdate) Set(val *IntervalBulkUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableIntervalBulkUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableIntervalBulkUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntervalBulkUpdate(val *IntervalBulkUpdate) *NullableIntervalBulkUpdate {
	return &NullableIntervalBulkUpdate{value: val, isSet: true}
}

func (v NullableIntervalBulkUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntervalBulkUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
