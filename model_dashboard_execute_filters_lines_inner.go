...
// checks if the DashboardExecuteFiltersLinesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DashboardExecuteFiltersLinesInner{}

// DashboardExecuteFiltersLinesInner struct for DashboardExecuteFiltersLinesInner
type DashboardExecuteFiltersLinesInner struct {
	Id *string
	Name *string
}

// NewDashboardExecuteFiltersLinesInner instantiates a new DashboardExecuteFiltersLinesInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDashboardExecuteFiltersLinesInner() *DashboardExecuteFiltersLinesInner {
	this := DashboardExecuteFiltersLinesInner{}
	return &this
}

// NewDashboardExecuteFiltersLinesInnerWithDefaults instantiates a new DashboardExecuteFiltersLinesInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDashboardExecuteFiltersLinesInnerWithDefaults() *DashboardExecuteFiltersLinesInner {
	this := DashboardExecuteFiltersLinesInner{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *DashboardExecuteFiltersLinesInner) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *DashboardExecuteFiltersLinesInner) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *DashboardExecuteFiltersLinesInner) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *DashboardExecuteFiltersLinesInner) SetId(v string) {
	o.Id = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *DashboardExecuteFiltersLinesInner) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *DashboardExecuteFiltersLinesInner) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *DashboardExecuteFiltersLinesInner) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *DashboardExecuteFiltersLinesInner) SetName(v string) {
	o.Name = &v
}

func (o DashboardExecuteFiltersLinesInner) MarshalJSON() ([]byte, error) {
...
func (o DashboardExecuteFiltersLinesInner) ToMap() (map[string]interface{}, error) {
...
type NullableDashboardExecuteFiltersLinesInner struct {
	value *DashboardExecuteFiltersLinesInner
	isSet bool
}

func (v NullableDashboardExecuteFiltersLinesInner) Get() *DashboardExecuteFiltersLinesInner {
	return v.value
}

func (v *NullableDashboardExecuteFiltersLinesInner) Set(val *DashboardExecuteFiltersLinesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDashboardExecuteFiltersLinesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDashboardExecuteFiltersLinesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDashboardExecuteFiltersLinesInner(val *DashboardExecuteFiltersLinesInner) *NullableDashboardExecuteFiltersLinesInner {
	return &NullableDashboardExecuteFiltersLinesInner{value: val, isSet: true}
}

func (v NullableDashboardExecuteFiltersLinesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDashboardExecuteFiltersLinesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
