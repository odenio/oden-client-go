...
// checks if the QualitySchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QualitySchema{}

// QualitySchema A schema for quality tests. Note: the id is currently implemented as a string, but that string should be a stringified integer. 
...
func (o QualitySchema) MarshalJSON() ([]byte, error) {
...
func (o QualitySchema) ToMap() (map[string]interface{}, error) {
...
type NullableQualitySchema struct {
	value *QualitySchema
	isSet bool
}

func (v NullableQualitySchema) Get() *QualitySchema {
	return v.value
}

func (v *NullableQualitySchema) Set(val *QualitySchema) {
	v.value = val
	v.isSet = true
}

func (v NullableQualitySchema) IsSet() bool {
	return v.isSet
}

func (v *NullableQualitySchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQualitySchema(val *QualitySchema) *NullableQualitySchema {
	return &NullableQualitySchema{value: val, isSet: true}
}

func (v NullableQualitySchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQualitySchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
