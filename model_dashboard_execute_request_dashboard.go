...
// checks if the DashboardExecuteRequestDashboard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DashboardExecuteRequestDashboard{}

// DashboardExecuteRequestDashboard struct for DashboardExecuteRequestDashboard
type DashboardExecuteRequestDashboard struct {
	Id string `json:"id"`
}

type _DashboardExecuteRequestDashboard DashboardExecuteRequestDashboard

// NewDashboardExecuteRequestDashboard instantiates a new DashboardExecuteRequestDashboard object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDashboardExecuteRequestDashboard(id string) *DashboardExecuteRequestDashboard {
	this := DashboardExecuteRequestDashboard{}
	this.Id = id
	return &this
}

// NewDashboardExecuteRequestDashboardWithDefaults instantiates a new DashboardExecuteRequestDashboard object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDashboardExecuteRequestDashboardWithDefaults() *DashboardExecuteRequestDashboard {
	this := DashboardExecuteRequestDashboard{}
	return &this
}

// GetId returns the Id field value
func (o *DashboardExecuteRequestDashboard) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *DashboardExecuteRequestDashboard) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *DashboardExecuteRequestDashboard) SetId(v string) {
	o.Id = v
}

func (o DashboardExecuteRequestDashboard) MarshalJSON() ([]byte, error) {
...
func (o DashboardExecuteRequestDashboard) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

func (o *DashboardExecuteRequestDashboard) UnmarshalJSON(data []byte) (err error) {
	...
	varDashboardExecuteRequestDashboard := _DashboardExecuteRequestDashboard{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDashboardExecuteRequestDashboard)

	if err != nil {
		return err
	}

	*o = DashboardExecuteRequestDashboard(varDashboardExecuteRequestDashboard)

	return err
}

type NullableDashboardExecuteRequestDashboard struct {
	value *DashboardExecuteRequestDashboard
	isSet bool
}

func (v NullableDashboardExecuteRequestDashboard) Get() *DashboardExecuteRequestDashboard {
	return v.value
}

func (v *NullableDashboardExecuteRequestDashboard) Set(val *DashboardExecuteRequestDashboard) {
	v.value = val
	v.isSet = true
}

func (v NullableDashboardExecuteRequestDashboard) IsSet() bool {
	return v.isSet
}

func (v *NullableDashboardExecuteRequestDashboard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDashboardExecuteRequestDashboard(val *DashboardExecuteRequestDashboard) *NullableDashboardExecuteRequestDashboard {
	return &NullableDashboardExecuteRequestDashboard{value: val, isSet: true}
}

func (v NullableDashboardExecuteRequestDashboard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDashboardExecuteRequestDashboard) UnmarshalJSON(src []byte) error {
	v.isSet = true
