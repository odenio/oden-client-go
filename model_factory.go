...
// checks if the Factory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Factory{}

// Factory An entity representing a factory.
type Factory struct {
	Id *string `json:"id,omitempty"`
	Name *string `json:"name,omitempty"`
	SecondaryName NullableString `json:"secondary_name,omitempty"`
...
// GetSecondaryName returns the SecondaryName field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Factory) GetSecondaryName() string {
	if o == nil || IsNil(o.SecondaryName.Get()) {
		var ret string
		return ret
	}
	return *o.SecondaryName.Get()
}
...
// SetSecondaryName gets a reference to the given NullableString and assigns it to the SecondaryName field.
func (o *Factory) SetSecondaryName(v string) {
	o.SecondaryName.Set(&v)
}
// SetSecondaryNameNil sets the value for SecondaryName to be an explicit nil
func (o *Factory) SetSecondaryNameNil() {
	o.SecondaryName.Set(nil)
}
...
func (o Factory) MarshalJSON() ([]byte, error) {
...
func (o Factory) ToMap() (map[string]interface{}, error) {
	...
	if o.SecondaryName.IsSet() {
		toSerialize["secondary_name"] = o.SecondaryName.Get()
	}
	if !IsNil(o.Timezone) {
...
func (v NullableFactory) Get() *Factory {
	return v.value
}

func (v *NullableFactory) Set(val *Factory) {
	v.value = val
	v.isSet = true
}

func (v NullableFactory) IsSet() bool {
	return v.isSet
}

func (v *NullableFactory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFactory(val *Factory) *NullableFactory {
	return &NullableFactory{value: val, isSet: true}
}

func (v NullableFactory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFactory) UnmarshalJSON(src []byte) error {
	v.isSet = true
