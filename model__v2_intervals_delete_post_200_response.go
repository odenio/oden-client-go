...
// checks if the V2IntervalsDeletePost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2IntervalsDeletePost200Response{}

// V2IntervalsDeletePost200Response struct for V2IntervalsDeletePost200Response
type V2IntervalsDeletePost200Response struct {
	NumDeleted *int32 `json:"num_deleted,omitempty"`
	FailedIntervals []string `json:"failed_intervals,omitempty"`
}
...
func NewV2IntervalsDeletePost200Response() *V2IntervalsDeletePost200Response {
	this := V2IntervalsDeletePost200Response{}
	return &this
}
...
// SetFailedIntervals gets a reference to the given []string and assigns it to the FailedIntervals field.
func (o *V2IntervalsDeletePost200Response) SetFailedIntervals(v []string) {
	o.FailedIntervals = v
}

func (o V2IntervalsDeletePost200Response) MarshalJSON() ([]byte, error) {
...
func (o V2IntervalsDeletePost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableV2IntervalsDeletePost200Response struct {
	value *V2IntervalsDeletePost200Response
	isSet bool
}

func (v NullableV2IntervalsDeletePost200Response) Get() *V2IntervalsDeletePost200Response {
	return v.value
}

func (v *NullableV2IntervalsDeletePost200Response) Set(val *V2IntervalsDeletePost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2IntervalsDeletePost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2IntervalsDeletePost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2IntervalsDeletePost200Response(val *V2IntervalsDeletePost200Response) *NullableV2IntervalsDeletePost200Response {
	return &NullableV2IntervalsDeletePost200Response{value: val, isSet: true}
}

func (v NullableV2IntervalsDeletePost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2IntervalsDeletePost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
