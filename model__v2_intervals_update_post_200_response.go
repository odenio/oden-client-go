...
// checks if the V2IntervalsUpdatePost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2IntervalsUpdatePost200Response{}

// V2IntervalsUpdatePost200Response struct for V2IntervalsUpdatePost200Response
type V2IntervalsUpdatePost200Response struct {
	NumUpdated *int32 `json:"num_updated,omitempty"`
	UpdatedIntervals []Interval `json:"updated_intervals,omitempty"`
	NumFailed *int32 `json:"num_failed,omitempty"`
	FailedIntervals []V2IntervalsUpdatePost200ResponseFailedIntervalsInner `json:"failed_intervals,omitempty"`
}
...
func NewV2IntervalsUpdatePost200Response() *V2IntervalsUpdatePost200Response {
	this := V2IntervalsUpdatePost200Response{}
	return &this
}
...
// GetNumUpdated returns the NumUpdated field value if set, zero value otherwise.
func (o *V2IntervalsUpdatePost200Response) GetNumUpdated() int32 {
	if o == nil || IsNil(o.NumUpdated) {
		var ret int32
		return ret
	}
	return *o.NumUpdated
...
// GetNumUpdatedOk returns a tuple with the NumUpdated field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V2IntervalsUpdatePost200Response) GetNumUpdatedOk() (*int32, bool) {
	if o == nil || IsNil(o.NumUpdated) {
		return nil, false
	}
	return o.NumUpdated, true
}
...
// SetNumUpdated gets a reference to the given int32 and assigns it to the NumUpdated field.
func (o *V2IntervalsUpdatePost200Response) SetNumUpdated(v int32) {
	o.NumUpdated = &v
}

// GetUpdatedIntervals returns the UpdatedIntervals field value if set, zero value otherwise.
func (o *V2IntervalsUpdatePost200Response) GetUpdatedIntervals() []Interval {
	if o == nil || IsNil(o.UpdatedIntervals) {
		var ret []Interval
		return ret
	}
	return o.UpdatedIntervals
}

// GetUpdatedIntervalsOk returns a tuple with the UpdatedIntervals field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V2IntervalsUpdatePost200Response) GetUpdatedIntervalsOk() ([]Interval, bool) {
	if o == nil || IsNil(o.UpdatedIntervals) {
		return nil, false
	}
	return o.UpdatedIntervals, true
}
...
// SetUpdatedIntervals gets a reference to the given []Interval and assigns it to the UpdatedIntervals field.
func (o *V2IntervalsUpdatePost200Response) SetUpdatedIntervals(v []Interval) {
	o.UpdatedIntervals = v
}
...
// GetFailedIntervals returns the FailedIntervals field value if set, zero value otherwise.
func (o *V2IntervalsUpdatePost200Response) GetFailedIntervals() []V2IntervalsUpdatePost200ResponseFailedIntervalsInner {
	if o == nil || IsNil(o.FailedIntervals) {
		var ret []V2IntervalsUpdatePost200ResponseFailedIntervalsInner
		return ret
	}
	return o.FailedIntervals
}

// GetFailedIntervalsOk returns a tuple with the FailedIntervals field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V2IntervalsUpdatePost200Response) GetFailedIntervalsOk() ([]V2IntervalsUpdatePost200ResponseFailedIntervalsInner, bool) {
	if o == nil || IsNil(o.FailedIntervals) {
		return nil, false
	}
	return o.FailedIntervals, true
}
...
// SetFailedIntervals gets a reference to the given []V2IntervalsUpdatePost200ResponseFailedIntervalsInner and assigns it to the FailedIntervals field.
func (o *V2IntervalsUpdatePost200Response) SetFailedIntervals(v []V2IntervalsUpdatePost200ResponseFailedIntervalsInner) {
	o.FailedIntervals = v
}

func (o V2IntervalsUpdatePost200Response) MarshalJSON() ([]byte, error) {
...
func (o V2IntervalsUpdatePost200Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.NumUpdated) {
		toSerialize["num_updated"] = o.NumUpdated
	}
	if !IsNil(o.UpdatedIntervals) {
		toSerialize["updated_intervals"] = o.UpdatedIntervals
	}
	if !IsNil(o.NumFailed) {
		toSerialize["num_failed"] = o.NumFailed
	}
	if !IsNil(o.FailedIntervals) {
		toSerialize["failed_intervals"] = o.FailedIntervals
	}
	return toSerialize, nil
}

type NullableV2IntervalsUpdatePost200Response struct {
	value *V2IntervalsUpdatePost200Response
	isSet bool
}

func (v NullableV2IntervalsUpdatePost200Response) Get() *V2IntervalsUpdatePost200Response {
	return v.value
}

func (v *NullableV2IntervalsUpdatePost200Response) Set(val *V2IntervalsUpdatePost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2IntervalsUpdatePost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2IntervalsUpdatePost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2IntervalsUpdatePost200Response(val *V2IntervalsUpdatePost200Response) *NullableV2IntervalsUpdatePost200Response {
	return &NullableV2IntervalsUpdatePost200Response{value: val, isSet: true}
}

func (v NullableV2IntervalsUpdatePost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2IntervalsUpdatePost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
