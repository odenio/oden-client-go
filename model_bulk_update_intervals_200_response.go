...
// checks if the BulkUpdateIntervals200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkUpdateIntervals200Response{}

// BulkUpdateIntervals200Response struct for BulkUpdateIntervals200Response
type BulkUpdateIntervals200Response struct {
	...
	FailedIntervals []BulkUpdateIntervals200ResponseFailedIntervalsInner `json:"failed_intervals,omitempty"`
}
...
func NewBulkUpdateIntervals200Response() *BulkUpdateIntervals200Response {
	this := BulkUpdateIntervals200Response{}
	return &this
}
...
func (o *BulkUpdateIntervals200Response) GetFailedIntervals() []BulkUpdateIntervals200ResponseFailedIntervalsInner {
	if o == nil || IsNil(o.FailedIntervals) {
		var ret []BulkUpdateIntervals200ResponseFailedIntervalsInner
		return ret
	}
...
// SetFailedIntervals gets a reference to the given []BulkUpdateIntervals200ResponseFailedIntervalsInner and assigns it to the FailedIntervals field.
func (o *BulkUpdateIntervals200Response) SetFailedIntervals(v []BulkUpdateIntervals200ResponseFailedIntervalsInner) {
	o.FailedIntervals = v
}

func (o BulkUpdateIntervals200Response) MarshalJSON() ([]byte, error) {
...
func (o BulkUpdateIntervals200Response) ToMap() (map[string]interface{}, error) {
...
type NullableBulkUpdateIntervals200Response struct {
	value *BulkUpdateIntervals200Response
	isSet bool
}

func (v NullableBulkUpdateIntervals200Response) Get() *BulkUpdateIntervals200Response {
	return v.value
}

func (v *NullableBulkUpdateIntervals200Response) Set(val *BulkUpdateIntervals200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkUpdateIntervals200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkUpdateIntervals200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkUpdateIntervals200Response(val *BulkUpdateIntervals200Response) *NullableBulkUpdateIntervals200Response {
	return &NullableBulkUpdateIntervals200Response{value: val, isSet: true}
}

func (v NullableBulkUpdateIntervals200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkUpdateIntervals200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
