...
// checks if the V2ScrapYieldSetPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ScrapYieldSetPostRequest{}

// V2ScrapYieldSetPostRequest struct for V2ScrapYieldSetPostRequest
type V2ScrapYieldSetPostRequest struct {
	Data ScrapYieldData `json:"data"`
	Interval Interval `json:"interval"`
}

type _V2ScrapYieldSetPostRequest V2ScrapYieldSetPostRequest
...
func NewV2ScrapYieldSetPostRequest(data ScrapYieldData, interval Interval) *V2ScrapYieldSetPostRequest {
	this := V2ScrapYieldSetPostRequest{}
	this.Data = data
...
func (o V2ScrapYieldSetPostRequest) MarshalJSON() ([]byte, error) {
...
func (o V2ScrapYieldSetPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *V2ScrapYieldSetPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varV2ScrapYieldSetPostRequest := _V2ScrapYieldSetPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV2ScrapYieldSetPostRequest)

	if err != nil {
		return err
	}

	*o = V2ScrapYieldSetPostRequest(varV2ScrapYieldSetPostRequest)

	return err
}

type NullableV2ScrapYieldSetPostRequest struct {
	value *V2ScrapYieldSetPostRequest
	isSet bool
}

func (v NullableV2ScrapYieldSetPostRequest) Get() *V2ScrapYieldSetPostRequest {
	return v.value
}

func (v *NullableV2ScrapYieldSetPostRequest) Set(val *V2ScrapYieldSetPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ScrapYieldSetPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ScrapYieldSetPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ScrapYieldSetPostRequest(val *V2ScrapYieldSetPostRequest) *NullableV2ScrapYieldSetPostRequest {
	return &NullableV2ScrapYieldSetPostRequest{value: val, isSet: true}
}

func (v NullableV2ScrapYieldSetPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ScrapYieldSetPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
